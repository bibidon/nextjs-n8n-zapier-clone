  ...
  const handleNodeSelect = useCallback((selection: NodeTypeOption) => {
    ...
    */
    if (selection.type === NodeType.MANUAL_TRIGGER) {
      ...
      if (hasManualTrigger) {
        toast.error("A manual trigger already exists. You can only have one.");
        return;
      }
    }
    ...
    setNodes((nodes) => {
      ...
      const floePosition = screenToFlowPosition({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      <SheetContent side="right" className="w-full sm:max-w-md overflow-y-auto">
        ...
        <SheetHeader>
          <SheetTitle>What tiggers this workflow?</SheetTitle>
          <SheetDescription>A triggegr is a step that starts your workflow.</SheetDescription>
        </SheetHeader>
