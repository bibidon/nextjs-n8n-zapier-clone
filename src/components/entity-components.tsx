...
export function EntityHeader({
  ...
  return (
    <div className="flex flex-row items-center justify-between gap-x-4">
      ...
      {onNew && !newButtonHref && (
        <Button size="sm" disabled={isCreated || disabled} onClick={onNew}>
...
export function EntityContainer({ header, search, pagination, children }: EntityContainerProps) {
  return (
...
export function EntityPagination({ page, totalPages, onPageChange, disabled }: EntityPaginationProps) {
  return (
...
export function EntityItem({
  ...
  async function handleRemove(e: React.MouseEvent<HTMLDivElement>) {
    e.preventDefault();
    e.stopPropagation();
